...
public class Exercise07_01 {
	...
	public static void main(String[] args) {
		...
		double[] scores = new double[numberOfStudents]; // Array of scores to be computed
		double best = 0; // The best score to be computer (assume scores >- 0)
		
		//Read score & find the best (i..e, the max)
